...
const password = 'DIEGO_blanco_2807'; // Volvemos a la que el usuario confirma y mi test validó en Turno 31
const googleSecret = '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';

conn.on('ready', () => {
    console.log('🔗 Conectado al servidor. Restaurando identidad con la llave confirmada...');
    ...
    conn.exec(finalCmd, (err, stream) => {
        ...
        stream.on('close', (code) => {
            console.log(`✅ Restauración completada (Código: ${code}).`);
            conn.end();
